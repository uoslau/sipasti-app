    ...
    <div class="nav-align-top mb-6">
        <ul class="nav nav-pills mb-4 ms-auto" role="tablist">
            <li class="nav-item">
                <button type="button" class="nav-link active" role="tab" data-bs-toggle="tab"
                    data-bs-target="#navs-pills-top-form" aria-controls="navs-pills-top-home" aria-selected="true">
                    Form
                </button>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <button type="button" class="nav-link" role="tab" data-bs-toggle="tab"
                    data-bs-target="#navs-pills-top-update" aria-controls="navs-pills-top-profile"
                    aria-selected="false">
                    Update
                </button>
            </li>
        ...
        <div class="tab-content border-top">
            ...
            <div class="tab-pane fade" id="navs-pills-top-import" role="tabpanel">
                <div class="col-12">
                    <h5 class="card-header text-center">[NEW] Import File Excel Petugas</h5>
            ...
            <div class="tab-pane fade" id="navs-pills-top-update" role="tabpanel">
                <div class="col-12">
                    <h5 class="card-header text-center">[UPDATE] Import File Excel Petugas</h5>
                    <div class="card-body demo-vertical-spacing demo-only-element">
